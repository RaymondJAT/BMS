...
export default function EmployeesPage() {
  ...
  // Fetch employees and lookup maps from central hook
  const {
    employees = [],
    departmentsMap = {},
    positionsMap = {},
  ...
  const filteredEmployees = useMemo(() => {
    return employees.filter((emp) => {
      ...
      const deptName = (departmentsMap[emp.department_id] || '').toLowerCase()
      const posTitle = (positionsMap[emp.position_id] || '').toLowerCase()
  ...
  }, [employees, searchTerm, statusFilter, departmentsMap, positionsMap])
  ...
  const columns = useMemo(
    ...
    [handleEdit, departmentsMap, positionsMap],
  )
